...
public class PlantCreatorUnitTest
{
    ...
    {
        DatabaseHandler.getDatabase(ApplicationProvider.getApplicationContext());
    }
    ...
    public void createSingularPlantTest() throws JSONException
    {
        ...
        DatabaseHandler.getDatabase(context).getPlantFromDBbyID(0);
        Plant comparedPlant = new Plant.PlantBuilder()
                ...
                .setDefault_image(BitmapFactory.decodeResource(context.getResources(), R.drawable.defaultimage))
                .buildPlant();
