...
public class UpdatePlantScheduleTest
{
    ...
    public void updatePlantScheduleFrom1to2()
    {
        ...
        AsyncTask.execute(() ->
        {
            plantSchedule.updatePlantSchedule(plant, 3);

            Plant fetchedFromDatabase = handler.getPlantFromDBbyID(0);
            Watering fetchedPlantSchedule = fetchedFromDatabase.getWateringCycle();
            assertEquals(fetchedPlantSchedule.getWateringInterval(), 3);
        });
    }
