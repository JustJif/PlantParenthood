...
public class PlantCreator {
    ...
    public ArrayList<Plant> createPlant(JSONObject nonparsedPlants, Context applicationContext,
        ...
        try {
            ...
            for (int i = 0; i < plantsList.length(); i++) {
                ...
                Plant newPlant = new Plant.PlantBuilder()
                        ...
                        .setDefault_image(BitmapFactory.decodeResource(applicationContext.getResources(),
            ...
            plantController.passPlantslist(createdPlantObjects, nonparsedPlants.getInt("current_page"),
                    nonparsedPlants.getInt("last_page"));
    ...
    public Plant createPlantFromDatabase(PlantSaveToDatabase newPlant, Watering wateringCycle) {
        ...
        if (newPlant.getDefault_image().length > 0) {
            Bitmap bitmap = BitmapFactory.decodeByteArray(newPlant.getDefault_image(), 0,
                    newPlant.getDefault_image().length);
